...
mod tests {
    ...
    fn create_random_secrets(size: usize) -> Vec<ARTScalarField> {
    ...
    fn test_art_tree_key_update() {
        ...
        let mut trusted_agent = ARTTrustedAgent::new(generator);
    ...
    fn test_art_node_removal() {
        ...
        let mut trusted_agent = ARTTrustedAgent::new(ART_G::generator());
        let (mut tree, trusted_root_key) = trusted_agent.compute_art_and_ciphertexts(&secrets);
